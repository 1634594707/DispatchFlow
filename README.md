...
<p align="center">
  <a href="docs/项目全面总结.md">
    <img src="https://img.shields.io/badge/Project%20Summary-Read%20Docs-22D3EE?style=for-the-badge&logo=readthedocs&logoColor=white" alt="项目全面总结"/>
  </a>
</p>

> 📘 **[项目全面总结](docs/项目全面总结.md)** — 功能层面（12 大核心模块）+ 底层逻辑层面（技术架构 / 核心数据结构 / 关键算法 / 数据流转 / 技术决策）。新人上手与面试深挖首选文档。
...
| [项目全面总结](docs/项目全面总结.md) | 功能 + 底层逻辑双维度总览（架构图 / 数据流转 / 关键算法 / 技术决策） |
