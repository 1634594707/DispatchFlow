...
GEO_SEEDS=("zjf_geo.sql" "zjf_road_network.sql" "zjf_amap_terminal_links.sql" "zjf_service_area.sql" "zjf_swap_cabinets.sql" "zjf_retire_nearfield_piles.sql" "zjf_facility_v2.sql" "zjf_charging_points.sql" "zjf_standby_slots.sql")
