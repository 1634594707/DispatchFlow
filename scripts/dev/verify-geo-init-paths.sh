...
GEO_SEEDS=("zjf_geo.sql" "zjf_road_network.sql" "zjf_amap_terminal_links.sql" "zjf_service_area.sql" "zjf_swap_cabinets.sql" "zjf_retire_nearfield_piles.sql" "zjf_facility_v2.sql" "zjf_charging_points.sql")
...
seed_to() { # $1=container —— 按依赖顺序应用**全部**地理 seed
  ...
  # ⚠ 以前这里只灌 zjf_geo.sql —— W2-c/W3-c 之后那只是**四份 seed 里的一份**，
