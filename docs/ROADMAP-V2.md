...
- [ ] VDA5050 MQTT 适配器（评估见 [`docs/phase15/VDA5050-EVALUATION.md`](./phase15/VDA5050-EVALUATION.md)）
- [ ] 车辆 VDA5050 配置 UI（manufacturer / serialNumber / nodeId 映射）
- [ ] MQTT broker 本地联调栈（mosquitto + 模拟 AGV 脚本）

#### 15.3 规模化

- [ ] 1000+ 车 MAPF 实时（需架构升级：图分区 / 预约表 / 外置求解器）
- [ ] 任务池索引 + 分页（见技术债务，规模化前置）
...
| **M6** | 15 | +14 周 | VDA5050 demo；垂直收尾；100 车稳定 | 15.1 ✅ · 评估 ✅ 2026-05-31 |
