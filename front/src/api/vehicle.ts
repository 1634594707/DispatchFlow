...
export function getVehicleList(parkId?: number) {
  return request.get<any, ApiResponse<VehicleAdminListItem[]>>('/admin/vehicles', { params: { parkId } })
}
...
export function getVehicleDetail(vehicleId: number, parkId?: number) {
